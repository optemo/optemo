/*   Helper functions. All of these are used in application.js. Functions marked with ** are public functions.
-------- AJAX ---------
...
optemo_module = (function (my) {
    ...
    my.getAllShownProductIds = function() {
    	var currentIds = [];
    ...
    my.addValueToCookie = function(name, value) {
    ...
    my.removeValueFromCookie = function(name, value) {
    	var savedData = readCookie(name), numDays = 30;
    	if (savedData) {
...
//Load start page via ajax as soon as the ajaxsend function has been processed (ie. now)
