...
@module "optemo_module", ->
  ...
  @BestBuyLandingElements = ->
    bb_divs = $("#pagecontentmain2 [id^=ctl00_CP], #pagecontentmain2 .articles-container, #pagecontentmain2 .ui-tabcontrol, #contentleft1 [id^=ctl00_CC], #contentleft1 .department-headline")
