...
// Egor Khmelev - http://egorkhmelev.github.com/jslider/ - hmelyoff@gmail.com
...
(function( $ ) {
    ...
    template: jSliderTmpl(
      '<span class="<%=className%>">' +
        '<table><tr><td>' +
          ...
          '<div class="<%=className%>-label <%=className%>-label-to"><span><%=settings.to%></span><span><%=settings.dimension%></span></div>' +

          '<div class="<%=className%>-value"><span></span><span><%=settings.dimension%></span></div>' +
          '<div class="<%=className%>-value <%=className%>-value-to"><span></span><span><%=settings.dimension%></span></div>' +
  ...
  jSlider.prototype = {
    ...
    create: function(){
      ...
      $.extend(this.o.labels[0], {
        label: this.o.labels[0].o.find("span:last")
      });

      $.extend(this.o.labels[1], {
        label: this.o.labels[1].o.find("span:last")
      });
      ...
      this.o.limits[1].find("span:first").html( this.nice(this.settings.to,this.o.limits[1].find("span:last")) ); //Relabel last limit
    ...
    redraw: function( pointer ){
      ...
      this.o.labels[pointer.uid].value.html(
        this.nice(
          pointer.value.origin, this.o.labels[pointer.uid].label
        )
      );
          ...
          case 0:
            if( sizes.border+sizes.label / 2 > another_label.o.offset().left-this.sizes.domOffset.left ){
              another_label.o.css({ visibility: "hidden" });
          	  another_label.value.html( this.nice( another.value.origin, another_label.label ) );

            	label.o.css({ visibility: "visible" });

            	prc = ( another.value.prc - prc ) / 2 + prc;
            	if( another.value.prc != pointer.value.prc ){
            	  label.value.html( this.nice(pointer.value.origin, label.label) + "&nbsp;&ndash;&nbsp;" + this.nice(another.value.origin, label.label) );
          ...
          case 1:
            if( sizes.border - sizes.label / 2 < another_label.o.offset().left - this.sizes.domOffset.left + another_label.o.outerWidth() ){
              another_label.o.css({ visibility: "hidden" });
            	...
            	if( another.value.prc != pointer.value.prc ){
            	  label.value.html( this.nice(another.value.origin, label.label) + "&nbsp;&ndash;&nbsp;" + this.nice(pointer.value.origin, label.label) );
              	sizes.label = label.o.outerWidth();
              	sizes.border = ( prc * this.sizes.domWidth ) / 100;
              }
            } else {
  ...
  jSliderPointer.inheritFrom(Draggable, {
    oninit: function( ptr, id, _constructor ){
      ...
      if (id == this.settings.top_handle) {
        this.setIndexOver();
      }
    },
      ...
      if ((typeof('optemo_module.loading_indicator_state.disable') != 'undefined') && (optemo_module.loading_indicator_state.disable == true)) {
        this.parent.settings.impatient_mousedown = true;
        return;
      }
  	  var coords = this._getPageCoords( evt );
      ...
      if (this.parent.settings.movable && $.isFunction(this.parent.settings.movable)) {
        ...
        $("#optemo_filter").data("which_slider", this.uid)
      ...
      if (this.parent.settings.impatient_mousedown == true) {
        this.parent.settings.impatient_mousedown = false;
        return;
      }
