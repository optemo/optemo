module Products
# TODO is this general or specific to products?
...
def match_product_to_product ptr, recclass=$model, series=[]
  ...
  return match_rec_to_product makes, modelnames,recclass, series
end

# Finds a record of the given db model by 
# possible make(aka brand) and model lists. 
# Example: match_rec_to_product( ['HP','hewlett-packard'],  ['Q123xd',nil], product)
...
def match_rec_to_product rec_makes, rec_modelnames, recclass=$model, series=[]
  matching = []
