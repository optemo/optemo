...
MySQL_Prepared_ResultSet::MySQL_Prepared_ResultSet(MYSQL_STMT *s, MySQL_Prepared_Statement * par) 
...
bool
MySQL_Prepared_ResultSet::absolute(int row)
{
	checkValid();
	if (row > 0) {
		if (row > (int) num_rows) {
...
void
MySQL_Prepared_ResultSet::checkValid()
{
	if (isClosed()) {
...
int
MySQL_Prepared_ResultSet::findColumn(const std::string& columnLabel)
{
	checkValid();
...
bool MySQL_Prepared_ResultSet::first()
{
	checkValid();
	if (num_rows) {
		row_position = 1;
...
bool MySQL_Prepared_ResultSet::getBoolean(int columnIndex)
{
	checkValid();
...
/* {{{ MySQL_Prepared_ResultSet::getBoolean() -I- */
bool MySQL_Prepared_ResultSet::getBoolean(const std::string& columnLabel)
{
	checkValid();
...
double
MySQL_Prepared_ResultSet::getDouble(int columnIndex)
{
	checkValid();
	/* internally zero based */
	columnIndex--;
	if (columnIndex >= num_fields || columnIndex < 0) {
		throw new DbcInvalidArgument(CPPCONN_FUNC, __LINE__, "MySQLPreparedResultSet::isNull: invalid 'columnIndex'");
	}
...
/* {{{ MySQL_Prepared_ResultSet::getDouble() -I- */
double
MySQL_Prepared_ResultSet::getDouble(const std::string& columnLabel)
{
	checkValid();
	int col_idx = findColumn(columnLabel);
	if (col_idx == -1) {
		throw new DbcInvalidArgument(CPPCONN_FUNC, __LINE__, "MySQL_Prepared_ResultSet::getDouble: invalid value of 'columnLabel'");
	}
...
int
MySQL_Prepared_ResultSet::getInt(int columnIndex)
{
	checkValid();
	/* internally zero based */
	columnIndex--;
	if (columnIndex >= num_fields || columnIndex < 0) {
		throw new DbcInvalidArgument(CPPCONN_FUNC, __LINE__, "MySQL_Prepared_ResultSet::getInt: invalid value of 'columnIndex'");
	}
	last_queried_column = columnIndex;
	switch (stmt->bind[columnIndex].buffer_length) {
		...
		case 8:
			return (int) !*stmt->bind[columnIndex].is_null? *reinterpret_cast<long long *>(stmt->bind[columnIndex].buffer):0;
		default:
			printf("Type is %d columnIndex=%d\n", columnIndex, stmt->bind[columnIndex].buffer_type);
			throw new DbcInvalidArgument(CPPCONN_FUNC, __LINE__, "MySQL_Prepared_ResultSet::getInt: invalid type");
	}
}
/* }}} */
...
/* {{{ MySQL_Prepared_ResultSet::getInt() -I- */
int
MySQL_Prepared_ResultSet::getInt(const std::string& columnLabel)
{
	checkValid();
	int col_idx = findColumn(columnLabel);
	if (col_idx == -1) {
		throw new DbcInvalidArgument(CPPCONN_FUNC, __LINE__, "MySQL_Prepared_ResultSet::getInt: invalid value of 'columnLabel'");
	}
...
long long
MySQL_Prepared_ResultSet::getLong(int columnIndex)
{
	checkValid();
	/* internally zero based */
	columnIndex--;
	...
	switch (stmt->bind[columnIndex].buffer_length) {
		...
		default:
			printf("Type is %d\n", stmt->bind[columnIndex].buffer_type);
			throw new DbcInvalidArgument(CPPCONN_FUNC, __LINE__, "MySQL_Prepared_ResultSet::getInt: invalid type");
	}
}
/* }}} */
...
/* {{{ MySQL_Prepared_ResultSet::getLong() -I- */
long long
MySQL_Prepared_ResultSet::getLong(const std::string& columnLabel)
{
	checkValid();
	int col_idx = findColumn(columnLabel);
	if (col_idx == -1) {
...
MySQL_Prepared_ResultSet::getMetaData()
{
	checkValid();
	throw new sql::DbcMethodNotImplemented("MySQL_Prepared_ResultSet::getMetaData()");
}
/* }}} */
...
const sql::Statement *
MySQL_Prepared_ResultSet::getStatement()
{
	return parent;
}
/* }}} */
...
std::string
MySQL_Prepared_ResultSet::getString(int columnIndex)
{
	checkValid();
	/* internally zero based */
	columnIndex--;
	if (columnIndex >= num_fields || columnIndex < 0) {
		throw new sql::DbcInvalidArgument(CPPCONN_FUNC, __LINE__, "MySQLPreparedResultSet::getString: invalid 'columnIndex'");
	}
	last_queried_column = columnIndex;
...
/* {{{ MySQL_Prepared_ResultSet::getString() -I- */
std::string
MySQL_Prepared_ResultSet::getString(const std::string& columnLabel)
{
	checkValid();
	int col_idx = findColumn(columnLabel);
	if (col_idx == -1) {
		throw new DbcInvalidArgument(CPPCONN_FUNC, __LINE__, "MySQL_Prepared_ResultSet::getString: invalid value of 'columnLabel'");
	}
...
bool
MySQL_Prepared_ResultSet::isAfterLast()
{
	checkValid();
...
bool
MySQL_Prepared_ResultSet::isBeforeFirst() 
{
	checkValid();
...
bool
MySQL_Prepared_ResultSet::isClosed()
{
	return !is_valid;
}
/* }}} */
...
bool
MySQL_Prepared_ResultSet::isFirst()
{
	checkValid();
...
bool
MySQL_Prepared_ResultSet::isLast()
{
	checkValid();
...
bool
MySQL_Prepared_ResultSet::isNull(int columnIndex)
{
	checkValid();
	/* internally zero based */
	columnIndex--;
	if (columnIndex >= num_fields || columnIndex < 0) {
		throw new DbcInvalidArgument(CPPCONN_FUNC, __LINE__, "MySQL_Prepared_ResultSet::isNull: invalid value of 'columnIndex'");
	}
	return (bool) *stmt->bind[columnIndex].is_null;
}
/* }}} */
...
/* {{{ MySQL_Prepared_ResultSet::isNull() -I- */
bool
MySQL_Prepared_ResultSet::isNull(const std::string& columnLabel)
{
	checkValid();
	int col_idx = findColumn(columnLabel);
	if (col_idx == -1) {
		throw new DbcInvalidArgument(CPPCONN_FUNC, __LINE__, "MySQL_Prepared_ResultSet::isNull: invalid value of 'columnLabel'");
	}
...
MySQL_Prepared_ResultSet::previous()
{
	...
	if (isBeforeFirst()) {
		...
		throw new sql::DbcException(CPPCONN_FUNC, __LINE__, "Error during mysql_stmt_fetch");
	}
...
size_t
MySQL_Prepared_ResultSet::rowsCount()
{
	checkValid();
...
bool
MySQL_Prepared_ResultSet::wasNull() 
{
	checkValid();
