...
namespace :scrape_123 do
  ...
  task :sandbox => :init do
    matchingsets = get_matching_sets Session.product_type.toner
  ...
  task :init => :environment do 
      ...
      Session.product_type = One23Cartridge
      require 'rubygems'
      require 'open-uri'
